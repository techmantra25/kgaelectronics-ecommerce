...
// });
	...
	jQuery("header .main-nav ul li").hover(
	  function () {
		jQuery(this).closest('header').addClass("header_color");
	  },
	  function () {
		jQuery(this).closest('header').removeClass("header_color");
	  }
	);
	...
	var cat_slide = new Swiper( '.swiper-container.two', {
	...
	var category_slide = new Swiper(".category_slide", {
		spaceBetween: 7,
		slidesPerView: 12,
		navigation: {
		  nextEl: ".next_btn",
	...
	var tv_slider = new Swiper(".tv_slider", {
		spaceBetween: 10,
		slidesPerView: 1,
		navigation: {
		  nextEl: ".tv-next",
	...
	var utensils_slider = new Swiper(".utensils_slider", {
		spaceBetween: 0,
		slidesPerView: 1,
		navigation: {
		  nextEl: ".swiper-next",
	...
	var chimney_slider = new Swiper(".chimney_slider", {
		spaceBetween: 10,
		slidesPerView: 1,
		navigation: {
		  nextEl: ".chimney-next",
	...
	$('.fan_item:first').addClass('active');
	$('.fanset_item:first').addClass('active');
	$('.fan_list li:first').addClass('active');
	$('.fan_list li').click(function(){
		if(!$(this).hasClass('active')) {
			$('.fan_list li.active').removeClass('active');
			$(this).addClass('active');
		} else {
			$(this).removeClass('active');
		}
		var demovalue = $(this).attr('data-fan'); 
		//$(this).next().addClass('active');
		$("#"+demovalue).addClass('active');
		$("#fan"+demovalue).addClass('active');
		$('.fan_item').not($("#"+demovalue)).removeClass('active');
		$('.fanset_item').not($("#"+demovalue)).removeClass('active');
		$('.fan_data_content').not($("#fan"+demovalue)).removeClass('active');
	});

	var cat_slide = new Swiper(".cat_slide", {
		spaceBetween: 10,
		slidesPerView: 3,
		freeMode: true,
		watchSlidesProgress: true,
	...
	var cat_thumbnail = new Swiper(".cat_thumbnail", {
		spaceBetween: 10,
		slidesPerView: 1,
		slideToClickedSlide: true,
		// navigation: {
...
// mouse slider
	...
	// // Sync the thumbnails with the main slider
	// mouse_thumbnail.on('click', function (swiper, event) {
	// 	var clickedIndex = swiper.clickedIndex;
	// 	mouse_slide.slideTo(clickedIndex);
	// });
	...
	var bottle_content = new Swiper(".bottle_content", {
		spaceBetween: 10,
		slidesPerView: 1,
		slideToClickedSlide: true,
		// navigation: {
	...
	var bottle_feature = new Swiper(".bottle_feature", {
		spaceBetween: 10,
		slidesPerView: 1,
		slideToClickedSlide: true,
		// navigation: {
	...
	cat_slide.on('slideChangeTransitionStart', function () {
		cat_thumbnail.slideTo(cat_slide.activeIndex);
		bottle_content.slideTo(cat_slide.activeIndex);
		bottle_feature.slideTo(cat_slide.activeIndex);
	});

	cat_thumbnail.on('transitionStart', function () {
		cat_slide.slideTo(cat_thumbnail.activeIndex);
		bottle_content.slideTo(cat_thumbnail.activeIndex);
		bottle_feature.slideTo(cat_thumbnail.activeIndex);
	});

	bottle_content.on('transitionStart', function () {
		cat_slide.slideTo(bottle_content.activeIndex);
		cat_thumbnail.slideTo(bottle_content.activeIndex);
		bottle_feature.slideTo(bottle_content.activeIndex);
	});

	bottle_feature.on('transitionStart', function () {
		cat_slide.slideTo(bottle_feature.activeIndex);
		cat_thumbnail.slideTo(bottle_feature.activeIndex);
		bottle_content.slideTo(bottle_feature.activeIndex);
	});

	$(".bud_list li").click(function(){
		//alert('dwdwwd');
		var optionValue = $(this).attr("data_bud");
		if(!$(this).hasClass('active')) {
			$('.bud_list li.active').removeClass('active');
			$(this).addClass('active');
		} else {
			$(this).removeClass('active');
		}
		if(optionValue){
			$(".image_area").not("." + optionValue).removeClass('active');
			$("." + optionValue).addClass('active');
		} else{
			$(".image_area").removeClass('active');
		}
	});

	$('.prod_details:first').addClass('active');
	$('.panel_left ul li:first').addClass('active');
	$('.panel_left ul li').click(function(){
		if(!$(this).hasClass('active')) {
			$('.panel_left ul li.active').removeClass('active');
			$(this).addClass('active');
		} else {
			$(this).removeClass('active');
		}
		var demovalue = $(this).attr('data-thumb'); 
		//$(this).next().addClass('active');
		$("#"+demovalue).addClass('active');
		$('.prod_details').not($("#"+demovalue)).removeClass('active');
	});

	// Nonstick cookware 

	var cookware_thumb1 = new Swiper(".mySwiperthumb1", {
		spaceBetween: 10,
		slidesPerView: 7,
		freeMode: true,
		watchSlidesProgress: true,
	});
	var cookware_item1 = new Swiper(".mySwiper1", {
		spaceBetween: 10,
		slidesPerView: "auto",
		// navigation: {
		//   nextEl: ".swiper-button-next",
		...
		// },
		thumbs: {
		  swiper: cookware_thumb1,
		},
	});

	var cookware_thumb2 = new Swiper(".mySwiperthumb2", {
		spaceBetween: 10,
		slidesPerView: 7,
		freeMode: true,
		watchSlidesProgress: true,
	});
	var cookware_item2 = new Swiper(".mySwiper2", {
		spaceBetween: 10,
		slidesPerView: "auto",
		// navigation: {
		//   nextEl: ".swiper-button-next",
		...
		// },
		thumbs: {
		  swiper: cookware_thumb2,
		},
	});

	var cookware_thumb3 = new Swiper(".mySwiperthumb3", {
		spaceBetween: 10,
		slidesPerView: 7,
		freeMode: true,
		watchSlidesProgress: true,
	});
	var cookware_item3 = new Swiper(".mySwiper3", {
		spaceBetween: 10,
		slidesPerView: "auto",
		// navigation: {
		//   nextEl: ".swiper-button-next",
		...
		// },
		thumbs: {
		  swiper: cookware_thumb3,
		},
	});

	var cookware_thumb4 = new Swiper(".mySwiperthumb4", {
		spaceBetween: 10,
		slidesPerView: 7,
		freeMode: true,
		watchSlidesProgress: true,
	});
	var cookware_item4 = new Swiper(".mySwiper4", {
		spaceBetween: 10,
		slidesPerView: "auto",
		// navigation: {
		//   nextEl: ".swiper-button-next",
		...
		// },
		thumbs: {
		  swiper: cookware_thumb4,
		},
	});

// 	// Add click event listeners to thumbnail images
// $('.thumb_banner .swiper-slide').on('click', function() {
//     // Get index of clicked thumbnail
//     var index = $(this).index();
//     // Activate the corresponding slide in the product_thumb Swiper
//     cookware_item1.slideTo(index);
//     cookware_item2.slideTo(index);
//     cookware_item3.slideTo(index);
//     cookware_item4.slideTo(index);
// });
	...
	// var mixer_slide = new Swiper(".mixer_slide", {
	// 	spaceBetween: 10,
	// 	slidesPerView: 1,
	// 	watchSlidesProgress: true,
	// });

	var mixer_thumb = new Swiper(".mixer_thumb", {
		spaceBetween: 10,
		slidesPerView: 6,
		// centeredSlides: true,
		initialSlide: 1,
	...
	/*
	var cat_thumb = new Swiper(".mySwiper", {
		spaceBetween: 10,
		slidesPerView: 4,
		freeMode: true,
		watchSlidesProgress: true,
	});
	var cat_item = new Swiper(".mySwiper2", {
		spaceBetween: 10,
		slidesPerView: "auto",
		// navigation: {
		//   nextEl: ".swiper-button-next",
	...
	var cat_thumb2 = new Swiper(".mySwiper3", {
		spaceBetween: 10,
		slidesPerView: 4,
		freeMode: true,
		watchSlidesProgress: true,
	});
	var cat_item2 = new Swiper(".mySwiper4", {
		spaceBetween: 10,
		slidesPerView: "auto",
		// navigation: {
		//   nextEl: ".swiper-button-next",
	...
	var cat_thumb3 = new Swiper(".mySwiper5", {
		spaceBetween: 10,
		slidesPerView: 4,
		freeMode: true,
		watchSlidesProgress: true,
	});
	var cat_item3 = new Swiper(".mySwiper6", {
		spaceBetween: 10,
		slidesPerView: "auto",
		// navigation: {
		//   nextEl: ".swiper-button-next",
	...
	var cat_thumb4 = new Swiper(".mySwiper7", {
		spaceBetween: 10,
		slidesPerView: 4,
		freeMode: true,
		watchSlidesProgress: true,
	});
	var cat_item4 = new Swiper(".mySwiper8", {
		spaceBetween: 10,
		slidesPerView: "auto",
		// navigation: {
		//   nextEl: ".swiper-button-next",
	...
	var cat_thumb5 = new Swiper(".mySwiper9", {
		spaceBetween: 10,
		slidesPerView: 4,
		freeMode: true,
		watchSlidesProgress: true,
	});
	var cat_item5 = new Swiper(".mySwiper10", {
		spaceBetween: 10,
		slidesPerView: "auto",
		// navigation: {
		//   nextEl: ".swiper-button-next",
	...
	*/
	...
	var bud_slider = new Swiper(".bud_slider", {
		spaceBetween: 10,
		slidesPerView: 1,
		navigation: {
		  nextEl: ".bud-next",
	...
	var feature_holder = new Swiper(".feature-holder", {
		spaceBetween: 20,
		slidesPerView: 4,
		navigation: {
		  nextEl: ".feature-next",
	...
	var inner_banner = new Swiper(".inner_banner", {
		spaceBetween: 10,
		slidesPerView: 1,
		// navigation: {
		//   nextEl: ".feature-next",
	...
	*/
	...
	$(".speaker_list li").click(function(){
		var optionValue = $(this).attr("data_bud");
		if(!$(this).hasClass('active')) {
			$('.speaker_list li.active').removeClass('active');
			$(this).addClass('active');
		} else {
			$(this).removeClass('active');
		}
		if(optionValue){
			$(".speaker_area").not("." + optionValue).removeClass('active');
			$("." + optionValue).addClass('active');
		} else{
			$(".speaker_area").removeClass('active');
		}
	});
	
	$('.mouse_list li:first').addClass('active');
	$('.mouse_list li').click(function(){
		if(!$(this).hasClass('active')) {
			$('.mouse_list li.active').removeClass('active');
			$(this).addClass('active');
		} else {
			$(this).removeClass('active');
		}
		var demovalue = $(this).attr('data_mouse'); 
		console.log(demovalue);
		//$(this).next().addClass('active');
		$("#mouse"+demovalue).addClass('active');
		$('.mouse_data_content').not($("#mouse"+demovalue)).removeClass('active');
	});

	/* Headphone Color button*/
	$('.headphone_list li:first').addClass('active');
	$('.headphone_list li').click(function(){
		if(!$(this).hasClass('active')) {
			$('.headphone_list li.active').removeClass('active');
			$(this).addClass('active');
		} else {
			$(this).removeClass('active');
		}
		var demovalue = $(this).attr('data_earphone'); 
		console.log(demovalue);
		//$(this).next().addClass('active');
		$("#earphone"+demovalue).addClass('active');
		$('.earphone_data_content').not($("#earphone"+demovalue)).removeClass('active');
	});
	...
	$('.cooker_list li').click(function(){
		if(!$(this).hasClass('active')) {
			$('.cooker_list li.active').removeClass('active');
			$(this).addClass('active');
		} else {
			$(this).removeClass('active');
		}
		var imagevalue = $(this).attr('data-image'); 
		//$(this).next().addClass('active');
		$("#"+imagevalue).addClass('active');
		$("#cook"+imagevalue).addClass('active');
		$('.cooker_data_image').not($("#"+imagevalue)).removeClass('active');
		$('.cooker_data_content').not($("#cook"+imagevalue)).removeClass('active');
	});

// air cooler_swiper_slider

var swiper = new Swiper(".aircooler_swiper", {
    navigation: {
      nextEl: ".swiper-button-next",
      prevEl: ".swiper-button-prev",
    },
  ...
  // mouse colour section 

//   $('.mouse_color li span').click(function(){
