...
class ContentController extends Controller
{
    ...
    public function blog(Request $request)
    {
        ...
        // dd($settings);
        return view('front.blog.index',compact('settings'));
    }
    ...
    public function blogDetail(Request $request, $slug)
    {
        ...
        $settings = Settings::where('status',1)->get();
        // dd($settings);
        return view('front.blog.detail', compact('data','settings'));
    }
    ...
    public function newsDetail(Request $request, $slug)
    {
        ...
        $settings = Settings::where('status',1)->get();
        return view('front.news.detail', compact('data','settings'));
    }
    ...
    {
        $global = Globals::latest()->where('status',1)->get();
        $settings = Settings::where('status',1)->get();
        return view('front.content.global',compact('global','settings'));
    }
}
