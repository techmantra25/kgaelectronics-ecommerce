...
<body>
			...
			<div class="row align-items-center justify-content-between">
				...
				<div class="col-auto d-none d-md-block ml-auto menu_area">
					<nav class="main-nav">
						<ul>
							<li>
								<a href="{{ route('front.home') }}" class="home"><svg xmlns="http://www.w3.org/2000/svg"
									...
									<ul>
										...
										<li>
											...
											<ul class="mega-drop-menu">
												...
												<li><a
														href="{{ route('front.category.detail', $childCatValue['slug']) }}"><img
						...
						<ul>
							...
							<li>
								<a href="{{route('front.user.login')}}">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
										fill="none"
										stroke="{{ (Auth::guard('web')->check()) ? '#c10909' : 'currentColor' }}"
										stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
					...
					<div class="row align-items-center align-items-sm-end">
						...
						<div class="col">
							<div class="footer-block">
								<ul class="social">
									<li><a href="{{$settings[9]->content}}" target="_blank"><i class="fab fa-facebook-f"
												aria-hidden="true"></i></a></li>
									<li><a href="{{$settings[10]->content}}" target="_blank"><i class="fab fa-twitter"
												aria-hidden="true"></i></a></li>
									<li><a href="{{$settings[12]->content}}" target="_blank"><i class="fab fa-instagram"
												aria-hidden="true"></i></a></li>
									<li><a href="{{$settings[11]->content}}" target="_blank"><i class="fab fa-youtube"
												aria-hidden="true"></i></a></li>
								</ul>
							</div>
						</div>
					...
					<div class="col-md-5 col-lg-5 mb-3 mb-md-0">
						<div class="newsletter-form">
							<form method="POST" action="{{route('front.subscription')}}" id="joinUsForm">@csrf
								...
								{{-- @if(Session::get('mailSuccess')) <p class="mb-0 text-white small">{{Session::get('mailSuccess')}}
								</p>@endif --}}
							</form>
							...
							<div class="col-sm-5">
								<div class="footer-block">
									...
									<ul class="footer-block-menu">
										...
										<li><a
												href="{{route('front.category.detail', $categoryValue->slug)}}">{{$categoryValue->name}}</a>
										</li>
										@endforeach
									</ul>
								</div>
							...
							<div class="col-sm-7">
								<div class="footer-block">
									...
									<ul class="footer-block-menu">
										...
										<li><a href="{{route('front.content.payment')}}">Payment, Voucher &
												Promotions</a></li>
	...
	<script src="{{ asset('node_modules/scrollmagic/scrollmagic/minified/plugins/debug.addIndicators.min.js') }}">
	</script>
		...
		$('#joinUsForm').on('submit', function (e) {
			...
			$.ajax({
				...
				success: function (result) {
					result.resp == 200 ? $icon = '<i class="fas fa-check"></i> ' : $icon =
