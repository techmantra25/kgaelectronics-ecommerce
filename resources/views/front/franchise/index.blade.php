...
<section class="franchise_gallery">
	<div class="container-fluid">
		...
		@if (count($our_store_data)>0)
		@foreach ($our_store_data as $item)
	...
	<div class="container">
		<div class="row">
			...
			@if (count($marketing_data)>0)
				@foreach ($marketing_data as $item)
...
<section class="contact_form" id="partnerForm">
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-9">
				<form  action="{{route('front.franchise.partner')}}" method="POST">@csrf
					<div class="row">
						<div class="col-sm-6">
						...
						<div class="col-sm-12">
							<div class="form-group justify-content-center align-items-center">
								...
								<input type="submit"  class="form_submit" value="Submit Now">
							</div>
						</div>
...
<script>
	...
	// 	$('#register_form').onlick(function(e){
	// 	$.ajax({
	// 		url: "{{ route('front.franchise.partner') }}",
	// 		type: 'POST',
	// 		data: $(this).serialize(),
	// 		success: function (response){
	// 			console.log(response.message);
	// 			$('#partnerResp').html('<p class="text-success">Form submitted successfully! Reloading...</p>');
	// 			setTimeout(function() {
	...
	// 		// 	$('#partnerResp').html('<p class="text-danger">There was an error submitting the form.</p>');
