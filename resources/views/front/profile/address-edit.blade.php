...
<div class="col-lg-9 col-md-8 col-12">
    <form method="POST" action="{{route('front.user.address.update',$data->id)}}">@csrf
        <div class="profile-card">
            <h3>Add Address</h3>
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Country/Region" name="country" value="{{$data->country}}">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="First Name" value="{{$data->fname ? $data->fname : Auth::guard('web')->user()->fname}}">
                        <label class="floating-label">First Name</label>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Last Name" value="{{$data->lname ? $data->lname : Auth::guard('web')->user()->lname}}">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Landmark" name="landmark" value="{{$data->landmark}}">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Location" id="location" name="location" value="{{$data->location ?? old('location')}}">
                        <label class="floating-label">Location</label>
                    </div>
                    @error('location')<p class="small text-danger mb-0">{{$message}}</p>@enderror
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="State" name="state" value="{{$data->state}}">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Pin Code" name="pin" value="{{$data->pin}}">
                        <label class="floating-label">Pin Code</label>
                    </div>
                    @error('pin')<p class="small text-danger mb-0">{{$message}}</p>@enderror
                </div>
               <!-- <div class="col-sm-12">
                    <div class="btn-group address_type" role="group" aria-label="Basic radio toggle button group">
                        <label class="floating-label">Address Type</label>
                        
                        <input type="radio" name="type" id="btnradio1" value="1" {{ (old('type') == 1 || $data->type == 1) ? 'checked' : '' }}>
                        <label class="btn rounded-left btn-outline btn-sm btn_lbl" for="btnradio1">Home</label>

                        <input type="radio" name="type" id="btnradio2" value="2" {{ (old('type') == 2 || $data->type == 2) ? 'checked' : '' }}>
                        <label class="btn btn-outline btn-sm btn_lbl" for="btnradio2">Office</label>

                        <input type="radio" name="type" id="btnradio3" value="3" {{ (old('type') == 3 || $data->type == 3) ? 'checked' : '' }}>
                        <label class="btn btn-outline btn-sm btn_lbl" for="btnradio3">Other</label>
                    </div>
                    @error('type')
