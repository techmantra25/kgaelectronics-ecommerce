															...
															<table width="550" border="0" cellspacing="0" cellpadding="0" class="amttable">
																...
																<tbody>
                                                                    ...
                                                                    <tr>
                                                                       ...
                                                                       <td style="color:#000; font-family:Arial, sans-serif; font-size:14px; line-height:20px; text-align:center; padding:4px; font-weight:400">{{$bookingProductVal->product_name}}</td
