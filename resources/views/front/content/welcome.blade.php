...
<section class="utensils_section">
    <div class="utensils_right">
        ...
        <div class="swiper utensils_slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="{{asset('img/utensils.png')}}">

                    <div class="utensils_content_left">
                        <ul>
                            <li><img src="{{asset('img/gas.png')}}"> Sutiable For Gas</li>
                    ...
                    <div class="utensils_content_right">
                        <h6>KGA</h6>
                        <h2>Sapphire Fry Pan</h2>
                        <h6>premium Quality</h6>
                        <ul>
                            <li>24 CM Diameter</li>
                ...
                <div class="swiper-slide">
                    ...
                    <img src="{{asset('img/utensils_1.png')}}">
                    <div class="utensils_content_right">
                        <h6>KGA</h6>
                        <h2>Sapphire Kadai</h2>
                        <h6>premium Quality</h6>
                        <ul>
                            <li>24 CM Diameter</li>
                            <li>5 layer Non-stick Coating</li>
                ...
                <div class="swiper-slide">
                    ...
                    <img src="{{asset('img/utensils_2.png')}}">
                    <div class="utensils_content_right">
                        <h6>KGA</h6>
                        <h2>Sapphire Tawa</h2>
                        <h6>premium Quality</h6>
                        <ul>
                            <li>30 CM Diameter</li>
                            <li>5 layer Non-stick Coating</li>
                            <li>Induction base</li>
                            <li>Granite finish</li>
                        </ul>
...
<section class="fan_section">
    <div class="chimney_banner text-center">
        <div class="swiper chimney_slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="{{asset('img/chimney_prod.png')}}">
                    <h2>FreshAir Pro</h2>
                    <ul>
    ...
    <div class="fan_area_left">
        <div class="fan_area">
            <div class="fan_item" id="ivory">               
                <div class="fan_image_shadow">
                    <img src="{{asset('img/kga_fan_1.png')}}">
                </div>
            ...
            <div class="fan_content">
                <h6>KGA</h6>
                <h2>Decorative Ceiling Fan for Home</h2>

                <ul class="fan_spec">
                    <li>
                        <img src="{{asset('img/strut-mounting.png')}}">
                        <div>
                            <h5>Mounting Type</h5>
                            <p>Downrod Mount</p>
                        </div>
                ...
                <ul class="color_spec fan_list">
                    <li data-fan="ivory"><span style="background: #FFFFF0;"></span></li>
                    <li data-fan="black"><span style="background: #000000;"></span></li>
                    <li data-fan="brown"><span style="background: #523b35;"></span></li>
                </ul>
                <a href="#" class="latest-btn-white">Order Now</a>
            </div>
        </div>
    </div>
</section>
...
<section class="first_category">
    ...
    <div class="small_cat">
        ...
        <div class="bud_area">
            <div class="image_area red active">
                <img src="{{asset('img/bluetooth_speaker.png')}}">
            </div>
        ...
        <ul class="bud_list">
            <li data_bud="red" class="active"><span style="background-color: #f00;"></span></li>
...
<section class="other_product_section">
    ...
    <div class="product_section_left">
        <img src="{{asset('img/hair_d.png')}}">

        <div class="other_content">
            <h2>Luxe 2000 Watts Professional Hair Dryer</h2>
            <ul>
                <li><img src="{{asset('img/negative-ion.png')}}"><h4>Mosturising Negetive Ion</h4></li>
                <li><img src="{{asset('img/thermometer.png')}}"><h4>Constant Temperature Hair Care</h4></li>
                <li><img src="{{asset('img/climate-change.png')}}"><h4>Indepandent Hot/Cold Air</h4></li>
                <li><img src="{{asset('img/recycling.png')}}"><h4>Energy Saving</h4></li>
            </ul>
            <a href="#" class="latest-btm">Order Now</a>
        </div>
        <img src="{{asset('img/hair_dry.png')}}" class="dryer_image">
    </div>
</section>
...
<section class="first_category">
    <div class="sandwitch_block">
        <div class="row">
            <div class="col-sm-7 pl-0">
                <img src="{{asset('img/kga_sandwitch.png')}}" class="img-fluid">
            </div>
            <div class="col-sm-5">
                <h3>Sandwich Maker with Fixed Grill Plates</h3>
                <ul class="toaster_list">
                    <li><img src="{{asset('img/isi_mark.png')}}"><h6>ISI Cord</h6></li>
    ...
    <div class="toaster_block">
        <div class="row align-items-center">
            <div class="col-sm-5">
                <h3>Luxury Black Auto Pop-Up Toaster</h3>
                <ul class="toaster_list">
                    <li><img src="{{asset('img/isi_mark.png')}}"><h6>ISI Cord</h6></li>
            ...
            <div class="col-sm-7">
                <img src="{{asset('img/kga_toaster.png')}}" class="img-fluid">
            </div>
        </div>
    </div>
</section>
...
<section class="earphone_section">
    ...
    <div class="earphone_right">
        <img src="{{asset('img/white_diamond.png')}}">
...
<section class="headphone_section">
    <div class="headphone_left">
        ...
        <div class="headphone_content">
            <h6>KGA</h6>
            <h2>Blue Diamond Luxury Wired Earphones with Mic</h2>
            <ul>
                <li>Super Extra Bass</li>
        ...
        <img src="{{asset('img/earphone.png')}}">
    </div>
