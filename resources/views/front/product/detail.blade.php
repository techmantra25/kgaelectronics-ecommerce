...
<section class="sticky_cart">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h2 class="mb-2 mb-sm-0">{{$data->name}}</h2>
            </div>
            <div class="col-sm-6">
                <div class="row justify-content-end">
                    <div class="col col-sm-auto">
                        <div class="product_price"><span>&#8377; {{$data->offer_price}}</span><del>&#8377; {{$data->price}}</del></div>
                    </div>
                    <div class="col-auto col-sm-auto pl-5">
                        @if(Auth::guard('web')->check())
                        <form method="POST" action="{{route('front.cart.add')}}"  id="">@csrf
                        <div class="item-qty mr-1">
                                <!-- <div class="cart-text">Quantity</div> -->
                                <div class="qty-box">
                                   
                                    <input class="counter" type="hidden" value="1" name="qty">
                        ...
                        <div class="check-button-holder">
                                ...
                                <button type="submit" class="addtocart_btn">Buy Now</button>
                            </div>
                        </form>
                        @else
                        <!--<a type="button" class="addtocart_btn" href="{{route('front.user.login')}}">Buy Now</a>-->
                        ...
                        @endphp
                        <a type="button" class="addtocart_btn" onclick="storeData({{$data->id}},'{{$data->name}}', 1)" href="{{route('front.user.login')}}">Buy Now</a>
                        @endif
        ...
        <div class="row justify-content-between">
                            ...
                            <div class="product-details__gallery__slider swiper-container">
                                <div class="slider swiper-wrapper">
                                    ...
                                    @php
                                        ...
                                        $lazyImages = \App\Models\ProductImage::where('product_id', $data->id)->get();
                    ...
                    <div class="product-details__content__holder">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <form method="POST" action="{{route('front.wishlist.add')}}" id="toggleWishlistForm">@csrf
                                <input type="hidden" name="product_id" value="{{$data->id}}">
                                {{-- <button type="submit" class="wishlist_btn wishlist_btn_none {{ ($wishlistCheck) ? 'active' : '' }}" style="width: 60px;{{ ($wishlistCheck) ? 'background: #c1080a;' : '' }}">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <!--<span class="n_code"># {{$data->style_no}}</span>-->
                            <a href="{{route('front.user.login')}}" id="toggleWishlistForm">
                        ...
                        <div class="product__pricing">
                            <span>&#8377; {{$data->offer_price}}</span> <del>&#8377; {{$data->price}}</del>

                            {{--<h3>
                            
                                &#8377;<span class="price_val">{{$displayPrice}}</span>
                            
                                &#8377; <span class="price_val">{{$productValue->offer_price}}</span>
            ...
            <div class="col-lg-5 col-12">
                ...
                {{-- <div class="discount_badge">
                    <div class="discount_badge_text">
                        <span>25% OFF</span>
                        <p>Order over &#8377;5000</p>
                    </div>
                    <div class="discount_badge_button">Until Nov 30, 2022</div>
                </div> --}}
                ...
                <div class="order_block">
                    ...
                    <div class="product__enquire">
                        <form method="POST" action="{{route('front.cart.add')}}" class="d-flex" id="">@csrf
                            <div class="item-qty mr-1">
                                <!-- <div class="cart-text">Quantity</div> -->
                                <div class="qty-box">
                                    ...
                                    <input class="counter" type="number" value="1" name="qty" readonly="readonly">
                            ...
                            {{-- <div class="stock_status ml-auto">
                                <h5><span>Stock:</span> 856</h5>
                            </div>

                            <div class="product_subtotal">
                                Total Price <span>&#8377; 34502</span>
                            </div> --}}

                            <div class="check-button-holder">
                                <input type="hidden" name="product_id" value="{{$data->id}}">
                                <input type="hidden" name="product_name" value="{{$data->name}}">
                                <button type="submit" id="addToCart__btn" class=""><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-bag"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg> <span>Add to Cart</span></button>
                            
                                <button type="submit" class="buy_now_button">Buy Now</button>
                            </div>
                        </form>
                    ...
                    <div class="product__enquire">
                            ...
                            <div class="check-button-holder">
                                ...
                                @endphp
                                <a type="button" id="addToCart__btn"  href="#" onclick="storeData({{$data->id}},'{{$data->name}}', 1)"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-bag"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg> <span>Add to Cart</span></a>
                            
                                <a type="button" class="buy_now_button" onclick="storeData({{$data->id}},'{{$data->name}}', 1)" href="{{route('front.user.login')}}">Buy Now</a>
                            </div>
                        </a>
                    ...
                    <div class="order_block_footer">
                        ...
                        <a href="#" class="share_product">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-share-2"><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"></line><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"></line></svg> Share Product
                        </a>
                    </div>
                    @else
                    <div class="order_block_footer">
                    ...
                    <ul class"list-unstyled p-0 m-0">
                        ...
                        <li>
                            <div class="review-top">
                                <div class="icon"></div>
                                <span class="name">{{$reviewItem->name}}</span>
                            </div>
                            <div class="review-rating">
                                <ul>
                                    @if ($reviewItem->rating == 0) 
                                        <li>No ratings</li>
                                    @elseif ($reviewItem->rating == 1) 
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star"></iconify-icon></i></li>
                                    <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                    @elseif ($reviewItem->rating > 1 && $reviewItem->rating < 2) 
                                     <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star-half"></iconify-icon></li>
                                     <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                     <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                     <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                    @elseif ($reviewItem->rating == 2) 
                                     <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                     <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                     <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                     <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                     <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                    @elseif ($reviewItem->rating > 2 && $reviewItem->rating < 3) 
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star-half"></iconify-icon></li>
                                     <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                    < <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                    @elseif ($reviewItem->rating == 3) 
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                     <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                     <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                    @elseif ($reviewItem->rating > 3 && $reviewItem->rating < 4) 
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star-half"></iconify-icon></li>
                                     <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                     @elseif ($reviewItem->rating == 4) 
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                     <li><iconify-icon icon="bi:star"></iconify-icon></li>
                                    @elseif ($reviewItem->rating > 4 && $reviewItem->rating < 5) 
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
                                    <li><iconify-icon icon="bi:star-fill"></iconify-icon></li>
              ...
              @if(!empty($relatedProducts))
                ...
                <div class="related-products-wrap">
                    <div class="inner-prodict-wrap">
					 @if(count($relatedProducts)>0)
                    <h2>You may also like</h2>
					@endif
                        @foreach($relatedProducts as $relatedProductKey => $relatedProductValue)

                        {{-- {{dd($relatedProductValue)}} --}}
                        <a href="{{ route('front.product.detail', $relatedProductValue->slug) }}" class="home-gallary__single" data-events data-cat="tshirt">
                            ...
                            <figcaption>
                                ...
                                <p>MRP (Inclusive of all taxes) Original Price:<del>&#8377; {{$relatedProductValue->price}}</del></p>
                                <h2>&#8377; {{$relatedProductValue->offer_price}}</h2>
                                {{--<h5>
...
@php
  $productreviewVideo=\App\Models\ProductReviewVideo::where('product_id',$data->id)->first();
  $productfeatureimage=\App\Models\ProductFeatureImage::where('product_id',$data->id)->get();
  $productreview=\App\Models\ProductReview::where('product_id',$data->id)->get();
@endphp
 {{-- {{dd($data->id)}} --}}
 {{-- {{dd($productfeatureimage)}} --}}
<section class="product-description-section">
    <div class="container">
        <!-- <div class="row align-items-center m-0 mb-5 mb-sm-4">
            <div class="col-lg-12">
                <h2 class="sections-heading">Product Features</h2>
            </div>
        </div> -->
       @if(!empty($productreviewVideo->link))
        <div class="product-video">
            <iframe width="100%" height="100%" src="{{$productreviewVideo->link}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
		@endif
		@if(count($productfeatureimage)>0)
        <h2>Features</h2>
		@endif
        <div class="feature-holder">
            <div class="swiper-wrapper">
				@foreach($productfeatureimage as $productfeatureimages)
                <div class="swiper-slide">
                    <div class="feature-image-box">
                        <!-- <img src="../img/b1.jpg"/> -->
                        {{-- {{dd(asset($productfeatureimages->image))}} --}}
                        <img src="{{asset($productfeatureimages->image)}}"/>
                    </div>
                </div>
				@endforeach
               {{-- <div class="swiper-slide">
                    <div class="feature-image-box">
                        <!-- <img src="../img/b2.jpg"/> -->
                        <img src="../img/product-details-banner2.jpg"/>
                    </div>
                </div>--}}
                <!-- <div class="swiper-slide">
                    <div class="feature-image-box">
...
<section id="related" class="related-product desktop-off">
    <div class="container">
        ...
        <div class="row">
            ...
            <a href="{{ route('front.product.detail', $relatedProductValue->slug) }}" class="home-gallary__single" data-events data-cat="tshirt">
                ...
                <figcaption>
                    <h4>{{$relatedProductValue->name}}</h4>
                    <h5><del>&#8377;{{$data->price}}</del><ins>&#8377;{{$data->offer_price}}</ins></h5>
                    {{--<h5>
                    @if (count($relatedProductValue->colorSize) > 0)
                        @php
                            $varArray = [];
...
// var swiper = new Swiper(".feature-holder", {
//     loop: true,
