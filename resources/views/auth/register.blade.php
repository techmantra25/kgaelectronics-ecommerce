                ...
                <div class="register-block">
                            <div class="left-part">
                                <div class="register-logo">
                                    <a href="{{route('front.home')}}"><img src="{{asset('img/KGA Logo.png')}}"></a>
                                </div>
                                <form method="POST" action="{{ route('front.user.create') }}">
                                    ...
                                    <div class="register-card">
                                        <div class="register-group">
                                            <input type="text" class="register-box" name="name" placeholder="Full Name" value="{{ old('name') }}" autofocus>
                                            <label class="floating-label">Full Name</label>
                                            @error('name') <p class="small text-danger mb-0">{{ $message }}</p> @enderror
                                        </div>
                                        <div class="register-group">
                            ...
                            <div class="right-part">
                                <img src="{{asset('img/kga-family.jpg')}}">
                            </div>
