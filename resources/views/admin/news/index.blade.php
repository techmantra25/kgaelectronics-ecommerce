                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <div class="row__action">
                                    <a href="{{ route('admin.news.view', $item->id) }}">Edit</a>
                                    <a href="{{ route('admin.news.view', $item->id) }}">View</a>
                                    <a href="{{ route('admin.news.status', $item->id) }}">{{($item->status == 1) ? 'Active' : 'Inactive'}}</a>
                                    <a href="{{ route('admin.news.delete', $item->id) }}" class="text-danger" onclick="return confirm('Are you sure?')">Delete</a>
                                </div>
                                </td>
                                <td>{{$item->title}}</td>
