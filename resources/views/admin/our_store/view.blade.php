...
@section('page', 'Our Stores detail')
...
<section>
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.franchise.our_stores.update', $data->id ) }}" enctype="multipart/form-data">
                    @csrf
                        <h4 class="page__subtitle">Edit Our Store</h4>
                        <div class="row">
