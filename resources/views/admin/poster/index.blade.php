...
@section('page', 'Poster ( You can upload only one poster)')
...
<section>
    <div class="row">
                            ...
                            <tr>
                                ...
                                <td class="file-holder">
                                    ...
                                    <div class="row__action">
                                        <a href="{{ route('admin.poster.view', $item->id) }}">Edit</a>
                                        <a href="{{ route('admin.poster.view', $item->id) }}">View</a>
                                        <a href="{{ route('admin.poster.status', $item->id) }}">{{($item->status == 1) ? 'Active' : 'Inactive'}}</a>
                                        <a href="{{ route('admin.poster.delete', $item->id) }}" onclick="return confirm('Are you sure?')" class="text-danger">Delete</a>
                                    </div>
                                </td>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.poster.store') }}" enctype="multipart/form-data">@csrf
                        ...
                        <div class="row">
                            <div class="col-md-12 card">
                                ...
                                <div class="card-body p-0">
									...
									<p class="small text-danger">Image Size: 1500px X 581px</p>
                                    <script>
