...
@section('page', 'MARKETING & SALES PROMOTION')
...
<section>
    <div class="row">
                            ...
                            <tr>
                                ...
                                <td class="file-holder">
                                    ...
                                    <div class="row__action">
                                        <a href="{{route('admin.franchise.marketing.show',$item->id)}}">Edit</a>
                                        <a href="{{route('admin.franchise.marketing.show',$item->id)}}">View</a>
                                        <a href="{{route('admin.franchise.marketing.status',$item->id)}}">{{($item->status == 1) ? 'Active' : 'Inactive'}}</a>
                                        <a href="{{route('admin.franchise.marketing.delete',$item->id)}}" onclick="return confirm('Are you sure?')" class="text-danger">Delete</a>
                                    </div>
                                </td>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.franchise.marketing.store') }}" enctype="multipart/form-data">@csrf
