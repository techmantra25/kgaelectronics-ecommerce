                    ...
                    <form action="{{ route('admin.category.bulkDestroy') }}">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="100%" style="text-align: center;" class="small text-muted">No data found</td>  
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
                        ...
                        <div class="row">
							...
							<div class="card shadow-sm">
								<div class="card-header">
									...
									<p class="small text-muted m-0">Add Banner from here</p>
								</div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <table class="table table-sm" id="timePriceTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <input class="form-control" type="text" name="bannername[]">
                                            </td>
											<td>
                                                <textarea class="form-control" type="text" name="bannerdesc[]"></textarea>
                                            </td>
											<td>
                                                <input class="form-control" type="text" name="bannerlink[]">
                                            </td>
                                            <td>
