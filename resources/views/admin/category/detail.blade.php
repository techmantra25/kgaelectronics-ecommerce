                ...
                <content>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-auto">
                            ...
                            <a href="{{ route('admin.category.banner.delete',$item->id,['cat_id' =>$data->id]) }}" onclick="return confirm('Are you sure ?')" class="btn btn-sm btn-danger">Delete</a>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{route('admin.category.banner.edit',$item->id)}}" method="POST" enctype="multipart/form-data">@csrf
                                        <input type="hidden" name="id" value="{{$item->id}}">
                                        <input type="hidden" name="cat_id" value="{{$data->id}}">
                                        
                                        <div class="form-group mb-3">
                                            <input class="form-control" type="text" name="bannername" placeholder="Add Title" value="{{$item->name ?? ''}}">
                                        </div>
                                        <div class="form-group mb-3">
                                            <textarea class="form-control" type="text" id="product_short_des" name="bannerdesc" placeholder="Add Description">{{$item->description ?? ''}}</textarea>
                                        </div>
										<div class="form-group mb-3">
                                            <input class="form-control" type="text" name="bannerlink" placeholder="Link" value="{{$item->link ?? ''}}">
                                        </div>
                                        <div class="form-group mb-3">
                                            <div class="card-body">
                                                <div class="w-100 product__thumb">
                                                ...
                                                <input type="file" id="icon" accept="image/*" name="bannerimage" >
...
<div class="modal fade" id="addSpecModal" tabindex="-1" aria-labelledby="addSpecModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('admin.category.banner.add')}}" enctype="multipart/form-data" method="POST">@csrf
                    <input type="hidden" name="cat_id" value="{{$data->id}}">
                    <div class="form-group mb-3">
                        <input class="form-control" type="text" name="bannername" placeholder="Add Title">
                    </div>
                    <div class="form-group mb-3">
                        <textarea class="form-control" type="text" id="bannerdesc" name="bannerdesc" placeholder="Add Description"></textarea>
                    </div>
					 <div class="form-group mb-3">
                                                <input class="form-control" type="text" name="bannerlink" placeholder="Add Link">
                                             </div>
                    <div class="col-md-6 card">
                        <div class="card-header p-0 mb-3">Banner </div>
                        <div class="card-body p-0">
                           
                            <input type="file" name="bannerimage" id="icon" accept="image/*">
...
<script>
        ...
        ClassicEditor
        .create( document.querySelector( '#bannerdesc' ) )
        .catch( error => {
            console.error( error );
        });
        ClassicEditor
