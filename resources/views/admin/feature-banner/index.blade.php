...
@section('page', 'Feature Banner ( You can upload only 3 images)')
...
<section>
    <div class="row">
                            ...
                            <tr>
                                ...
                                <td class="file-holder">
                                    ...
                                    <div class="row__action">
                                        <a href="{{ route('admin.feature-banner.view', $item->id) }}">Edit</a>
                                        <a href="{{ route('admin.feature-banner.view', $item->id) }}">View</a>
                                        <a href="{{ route('admin.feature-banner.status', $item->id) }}">{{($item->status == 1) ? 'Active' : 'Inactive'}}</a>
                                        <a href="{{ route('admin.feature-banner.delete', $item->id) }}" onclick="return confirm('Are you sure?')" class="text-danger">Delete</a>
                                    </div>
                                </td>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.feature-banner.store') }}" enctype="multipart/form-data">@csrf
                        ...
                        <div class="row">
                            <div class="col-md-12 card">
                                ...
                                <div class="card-body p-0">
									...
									<p class="small text-danger">Image Size: 1067px X 600px</p>
                                    <script>
