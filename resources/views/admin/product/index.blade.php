            ...
            <div class="row align-items-center justify-content-between">
                <div class="col">
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col">
                            <button type="submit" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure ?')">Apply</button>
                        </div>
                    </div>
                </div>
				 <div class="col-auto">
				...
				<div class="col-auto">
				       <a href="{{route('admin.product.create')}}"  class="btn btn-danger mt-2">Add Product</a>
				</div>
                <div class="col-auto">
                    @php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="row__action">
                            ...
                            {{-- <a href="{{ route('admin.product.delete', $item->id) }}" class="text-danger" onclick="return confirm('Are you sure ?')">Delete</a> --}}
                        </div>
                    </td>
                    ...
                    <td>
                        ...
                        >
                       {{-- <a
                            href="{{ route('admin.subcategory.view', $item->subCategory->id) }}">{{$item->subCategory ? $item->subCategory->name : 'NA'}}</a>--}}
                    </td>
                    <td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('admin.product.variation.csv.upload') }}" enctype="multipart/form-data" id="borrowerCsvUpload">@csrf
                    ...
                    <br>
                    <a href="{{ asset('admin/static/product-sample.csv') }}">Download Sample CSV</a>
                    <br>
