...
<section>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            @forelse ($requisite_data as $index => $item)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                ...
                                <td class="file-holder">
                                    ...
                                    <div class="row__action">
                                        <a href="{{route('admin.franchise.requisite.show',$item->id)}}">Edit</a>
                                        <a href="{{route('admin.franchise.requisite.show',$item->id)}}">View</a>
                                        <a href="{{route('admin.franchise.requisite.status',$item->id)}}">{{($item->status == 1) ? 'Active' : 'Inactive'}}</a>
                                        <a href="{{route('admin.franchise.requisite.delete',$item->id)}}" onclick="return confirm('Are you sure?')" class="text-danger">Delete</a>
                                    </div>
                                </td>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.franchise.requisite.store') }}" enctype="multipart/form-data">@csrf
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea type="text" name="description" id="description" placeholder="" class="form-control">{{old('description')}}</textarea>
